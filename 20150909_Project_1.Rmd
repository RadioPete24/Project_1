...
#Plotting and summarizing the data (Plot 1)
# 
# ggplot(subdate_hh_power, aes(x=CXR_freq), color = "red") + geom_histogram(binwidth = 0.1, aes(fill = ..count..)) + 
# qplot(Global_active_power, data = subdate_hh_power, geom = "histogram", binwidth = 7)
...
p3 <- ggplot(subdate_hh_power, aes(x=timestamp)) +
          ...
          theme(plot.title = element_text(size = 20, hjust = 0), 
                ...
                axis.line = element_line(colour = "black"),
                panel.background = element_blank()) +     
          scale_colour_manual(values = c("Sub_metering_1" = "black", "Sub_metering_2" = "blue", "Sub_metering_3" = "red"))
    #plot4
